...
import { SiJavascript, SiNodedotjs, SiReact, SiHtml5, SiCss3, SiBootstrap, SiMongodb, SiExpress, SiMysql, SiJava, SiCplusplus, SiGithub, SiPython } from 'react-icons/si'
function Skills() {
    return (
        <Fragment>
                        ...
                        <div className="col-lg-6 col-md-12 col-sm-12 d-flex align-items-center">
                            <div>
                                ...
                                <div className="row my-2">
                                    ...
                                    <div className='mx-2 my-3 border rounded py-1 px-2 mw-fc'>
                                        <span><SiMysql className='fs-4' /> SQL</span>
                                    </div>
                                    <div className='mx-2 my-3 border rounded py-1 px-2 mw-fc'>
