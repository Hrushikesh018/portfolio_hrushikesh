...
import { AiFillLinkedin, AiFillSkype, AiFillGithub, AiOutlineUnorderedList, AiFillInstagram } from 'react-icons/ai'
...
function Sidebar() {
    function handleDownloadClick() {
        ...
        downloadLink.href = 'https://drive.google.com/file/d/182tKbHf8cLZh2GWEMS1bh2gNp7OC0lrs/view?usp=sharing';
        downloadLink.download = 'Aayush_khunger_resume.pdf';
            ...
            <div className="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark slide-in-left">
                <div className="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                    <Link to="/" className="d-flex align-items-center pb-1 mb-md-0 me-md-auto text-white text-decoration-none">
                        <span className="fs-5 d-none d-sm-inline ff-jost fw-600">Hrushikesh</span>
                    </Link>
                    <ul className="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                        ...
                        <li className="nav-item">
                            <button onClick={handleDownloadClick} className="nav-link align-middle px-0 text-white">
                    ...
                    <div className="dropdown pb-4 dropup">
                        ...
                        <ul className="dropdown-menu shadow" aria-labelledby="dropdownUser1">
                            <li><a className="dropdown-item text-black" href="mailto:hrushikesh.1804@gmail.com" target="/blank"><MdEmail className='fs-5' /> Email</a></li>
                            <li> <hr className="dropdown-divider" /> </li>
                            <li><a className="dropdown-item text-black" href="https://www.linkedin.com/in/hrushikesh-kadudula/" target="/blank"><AiFillLinkedin className='fs-5' /> LinkedIn</a></li>
                            <li> <hr className="dropdown-divider" /> </li>
                            <li><a className="dropdown-item text-black" href="https://www.instagram.com/hrushikesh_18_/" target="/blank"><AiFillInstagram className='fs-5' /> Instagram</a></li>
                        </ul>
                    </div>
                </div>
            </div>
